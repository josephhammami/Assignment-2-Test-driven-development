...
class DiceHand:
    """
    This class will keep track of the player score and their actions throughout the game.
    """

    def __init__(self):
        """
        Initializes a DiceHand object with a player_score of 0 and a dice object.
        """
        self.player_score = 0
        self.dice = dice()
